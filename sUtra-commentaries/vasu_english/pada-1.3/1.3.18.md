...
The verb डुक्रीञ् 'to buy or barter,' has an indicatory ञ् and therefore, by <i>sutra</i> [[1.3.72]] it will be <i>Atmanepadi</i> when the fruit of the action accrues to the agent. The present <i>sutra</i>, therefore, refers to cases where the fruit of the action does not accrue to the agent.
