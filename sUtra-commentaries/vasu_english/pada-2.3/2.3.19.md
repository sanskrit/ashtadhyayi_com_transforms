...
---
When the word सह 'with', is joined to a word the latter takes the 3rd case, when the sense is that the word in the 3rd case is not the principal but the accompaniment of the principal thing.
