...
Answer:- If you say that <i>pluta</i> is <i>siddha</i> in the vowel <i>sandhi</i> rules, because of the <i>jnapaka</i> in <i>sutra</i> [[6.1.125]], then still this rule is necessary in order to prevent the lengthening of [[6.1.101]], and the <i>Sakala</i> rule [[6.1.127]].
