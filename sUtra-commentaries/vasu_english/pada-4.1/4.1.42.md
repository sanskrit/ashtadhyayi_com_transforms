...
---
Thus जानपदी 'a profession', otherwise जानपदी, the difference being in accent only. For this word is formed by adding the affix अञ् to <i>janapada</i>, by <i>sutra</i> [[4.1.86]], as it belongs to <i>Utsadi</i> class of words: in forming the feminine the affix ङीप् will be added in this latter case, thus throwing the acute accent on the first syllable.
